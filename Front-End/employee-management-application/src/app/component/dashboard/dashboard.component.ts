...
export class DashboardComponent implements OnInit {
  ...
  editEmployee(emp: Employee) {
    ...
    this.empDetail.controls['employeeFirstName'].setValue(
  ...
  updateEmployee() {
    ...
    this.empService
      .updateEmployee(this.empObj, this.empObj.employeeId)
      .subscribe(
        (res) => {
          console.log(res);
          this.getAllEmployee();
  ...
  viewEmployee(emp: Employee) {
    ...
    this.empService.viewEmployee(emp.employeeId).subscribe(
      (res) => {
        console.log(res);
        this.getAllEmployee();
      },
